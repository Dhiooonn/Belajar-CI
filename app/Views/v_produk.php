...
<!-- tampilan aktivitas create data - Start -->
<?php
...
<!-- tampilan aktivitas create data - End -->
...
<table class="table datatable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <!-- fitur Edit dan Delete Data - Start -->
            <td>
            ...
            <!-- fitur Edit dan Delete Data - End -->
        </tr>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <!--  fungsi csrf_field() akan menghasilkan input dengan type hidden yang isinya token untuk melindungi dari serangan Cross-Site Request Forgery (CSRF) -->
